...
import (
	...
	"github.com/SAHIL-Sharma21/go-taskForge/internal/database"
	"github.com/SAHIL-Sharma21/go-taskForge/internal/lib/job"
	loggerPkg "github.com/SAHIL-Sharma21/go-taskForge/internal/logger"
...
func New(cfg *config.Config, logger *zerolog.Logger, loggerService *loggerPkg.LoggerService) (*Server, error) {
	...
	// Add New Relic hooks if available
	...
	if err := redisClient.Ping(ctx).Err(); err != nil {
		...
		// Don't fail startup is Redis is unavailable
	}
	...
	// Runtime metrics are automatically by New Relic GO agent
