...
func LoadConfig() (*Config, error) {
	...
	err := k.Load(env.Provider("TASKFORGE_", ".", func(s string) string {
		return strings.ToLower(strings.TrimPrefix(s, "TASKFORGE_"))
	}), nil)
	...
	// Override service name and environmant from primary config
	mainConfig.Observability.ServiceName = "taskForge"
	mainConfig.Observability = DefaultObservabilityConfig()
