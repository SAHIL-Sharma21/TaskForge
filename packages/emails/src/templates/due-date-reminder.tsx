import {
  ...
  export const DueDateReminderEmail = ({
    ...
    const urgencyColor = parseInt(daysUntilDue) <= 1 ? "text-red-600" : "text-orange-600";
    const urgencyMessage = parseInt(daysUntilDue) <= 1 ? "due tomorrow" : `due in ${daysUntilDue} days`;
